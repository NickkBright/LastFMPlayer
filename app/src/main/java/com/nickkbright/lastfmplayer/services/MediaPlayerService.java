package com.nickkbright.lastfmplayer.services;
...
import com.nickkbright.lastfmplayer.utilities.PlaybackStatus;
...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PREVIOUS = "com.nickkbright.lastfmplayer.ACTION_PREVIOUS";
    ...
    private void updateMetaData() {
        Bitmap albumArt = BitmapFactory.decodeResource(getResources(), R.drawable.logo); //replace with medias albumArt
    ...
    private void register_playNewAudio() {
        IntentFilter filter = new IntentFilter(PlayerFragment.Broadcast_PLAY_NEW_AUDIO);
